...
const NavBar = () => {
    ...
    return (
        <>
            <div className="mx-4 sm:mx-auto sm:max-w-7xl mt-6 mb-0">
                <nav className="flex items-center justify-between px-4 sm:px-6 py-1 sm:py-3 bg-black rounded-full w-full">
                    ...
                    <div className="flex items-center gap-4">
                        <Link to="/download" className="bg-gradient-to-tr from-indigo-400 to-purple-500 px-6 py-2 rounded-full text-white font-semibold shadow-lg hover:scale-105 transition hidden md:block">Download App</Link>
                        <button
            ...
            <div className={`md:hidden fixed inset-0 bg-black bg-opacity-95 z-50 transition-opacity duration-300 ${isMobileMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
